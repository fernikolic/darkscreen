...
export const apps: CryptoApp[] = [
  ...
  },
  {
    ...
    screens: [
      { step: 1, label: "Swap interface", flow: "Home", image: "/screenshots/uniswap-swap.png" },
      { step: 2, label: "Pool overview", flow: "Home", image: "/screenshots/uniswap-pool.png" },
      { step: 3, label: "Token explorer", flow: "Home", image: "/screenshots/uniswap-tokens.png" },
  ...
  },
  {
    ...
    screens: [
      { step: 1, label: "Markets overview", flow: "Home", image: "/screenshots/aave-markets.png" },
      { step: 2, label: "Your supplies dashboard", flow: "Home", image: "/screenshots/aave-supply.png" },
      ...
      { step: 1, label: "Connect wallet prompt", flow: "Settings", image: "/screenshots/aave-governance.png" },
  ...
  // ─── BASIC LISTINGS — EXCHANGES ────────────────────────────────
  {
    ...
    flows: ["Home", "Onboarding", "Swap", "Send", "Staking", "Settings"],
    screens: [
      { step: 1, label: "Markets overview", flow: "Home", image: "/screenshots/binance-markets.png" },
      { step: 2, label: "Spot trading interface", flow: "Home", image: "/screenshots/binance-trade.png" },
      { step: 3, label: "Portfolio dashboard", flow: "Home", image: "/screenshots/binance-home.png" },
      { step: 1, label: "Sign up form", flow: "Onboarding" },
      { step: 2, label: "Identity verification", flow: "Onboarding" },
      { step: 1, label: "Convert interface", flow: "Swap", image: "/screenshots/binance-trade.png" },
      { step: 2, label: "Enter amount", flow: "Swap" },
  ...
  // ─── BASIC LISTINGS — DEFI ─────────────────────────────────────
  {
    ...
    screens: [
      ...
      { step: 1, label: "Select token pair", flow: "Swap", image: "/screenshots/jupiter-home.png" },
      { step: 2, label: "Enter swap amount", flow: "Swap" },
  ...
  },
  {
    ...
    screens: [
      { step: 1, label: "Staking dashboard", flow: "Home", image: "/screenshots/lido-stake.png" },
      { step: 2, label: "APR overview", flow: "Home", image: "/screenshots/lido-home.png" },
      ...
      { step: 1, label: "Reward history", flow: "Settings", image: "/screenshots/lido-wrap.png" },
